...
const changePokemonId = $(( value: number ) => {
  ...
  return (
    <>
      ...
      <PokemonImage id={pokemonId.value} size={250} backImage={showBackImage.value}/>
      <div class='mt-2'>
        ...
        <button onClick$={ () => showBackImage.value = !showBackImage.value } class='btn btn-primary'>Rotate</button>
